                    ...
                    <?php foreach ($courses as $course): ?>
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="card course-card h-100">
                                <img src="<?php echo (!empty($course['gambar']) && file_exists($course['gambar'])) ? $course['gambar'] : '../asset/placeholder_image.png'; ?>" class="card-img-top"
                                    alt="<?php echo htmlspecialchars($course['judul']); ?>">
                ...
                <?php else: ?>
                    <div class="col-12">
                        <div class="col-12 text-center">
                            ...
                            <a href="../courses/Halaman.php#courses" class="btn btn-lg btn-success">
